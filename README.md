...
| <a name="input_autofailover"></a> [autofailover](#input\_autofailover) | (Obsolete) Configuration setting which enables and disables auto failover in the cluster. Do not use.| `bool` | `true` | no |
